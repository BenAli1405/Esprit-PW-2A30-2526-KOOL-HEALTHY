...
<p>back office ·</p>
  ...
  <main class="main-content">
    ...
    <div class="unified-container">
      ...
      <div class="section-card" id="pendingDefisSection" style="border-left: 6px solid #FFC107; scroll-margin-top: 100px;">
        <div class="section-header">
          <h2><i class="fas fa-hourglass-half" style="color: #FFC107;"></i> Défis en attente de validation</h2>
        </div>
          ...
          <table class="data-table" style="width:100%">
            ...
            <tbody>
              ...
              if (empty($pendingDefis)): ?>
                <tr><td colspan="6" style="text-align:center; padding:20px; color:#999;">Aucun défi en attente.</td></tr>
              <?php else: 
                ...
                <tr id="pending-row-<?= $defi['id'] ?>">
                  ...
                  <td>
                    <a href="../CONTROLLER/DefiController.php?action=approve&id=<?= $defi['id'] ?>" class="btn-primary" style="background:#4CAF50; padding:6px 12px; font-size:0.7rem;"><i class="fas fa-check"></i> Approuver</a>
                    <a href="../CONTROLLER/DefiController.php?action=reject&id=<?= $defi['id'] ?>" class="btn-danger" style="padding:6px 12px; font-size:0.7rem;"><i class="fas fa-times"></i> Refuser</a>
                  </td>
                </tr>
