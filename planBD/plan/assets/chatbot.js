    ...
    function injectHTML() {
        ...
        panel.innerHTML =
            ...
            '<div class="chatbot-quick-actions">' +
                '<button class="chatbot-quick-btn" data-msg="Comment se passe ma progression ?">📊 Progression</button>' +
                '<button class="chatbot-quick-btn" data-msg="Donne-moi une idée de recette rapide">🍳 Recette</button>' +
                '<button class="chatbot-quick-btn" data-msg="Rappelle-moi mon objectif">🎯 Mon plan</button>' +
                '<button class="chatbot-quick-btn" data-msg="Combien de calories dois-je manger par jour ?">🔥 Calories</button>' +
                '<button class="chatbot-quick-btn" data-msg="Analyse mes notes de repas">📋 Analyser notes</button>' +
                '<button class="chatbot-quick-btn" data-msg="Montre-moi mes repas d\'hier">🍽️ Hier</button>' +
            '</div>' +
