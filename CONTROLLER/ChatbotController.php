...
class ChatbotController
{
    ...
    private function handleSendMessage(array $data): void
    {
        ...
        $sentiment    = $this->chatbotModel->analyserSentiment($message);
        $repasRecents = $this->chatbotModel->getRepasRecents($planId, 5);
        $reponse      = $this->chatbotModel->genererReponse($sentiment, $repasRecents);
        $saved        = $this->chatbotModel->sauvegarderConversation($planId, $message, $reponse, $sentiment);
    ...
    private function handleGetHistorique(array $data): void
    {
        ...
        $historique = $this->chatbotModel->getHistorique($planId, $limit);
