    ...
    <div class="layout">
        ...
        <main class="main-col">
            <section class="panel composer" id="partage-recette">
                ...
                <form method="POST" action="../CONTROLLER/addRecette.php" enctype="multipart/form-data">
                    <input type="text" name="titre" placeholder="Titre de la recette (ex: Salade fraiche quinoa)" required>
                    <input type="number" name="temps_prep" min="1" placeholder="Temps de preparation (en minutes)" required>
                    <input type="text" name="ingredients" placeholder="Ingredients (separes par des virgules)" required>
