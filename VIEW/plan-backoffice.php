...
if (basename($_SERVER['SCRIPT_FILENAME']) === basename(__FILE__)) {
    header('Location: ../plan.php?page=plan-backoffice');
    exit;
}
...
<head>
  ...
  <link rel="stylesheet" href="VIEW/css/backoffice.css?v=20260512">
  <style>
    ...
    .filter-btn { border: 1px solid var(--gris-moyen); border-radius: 999px; background: var(--blanc); color: #4A5B4E; font-weight: 600; padding: 10px 14px; cursor: pointer; transition: background 0.2s, border-color 0.2s; }
    ...
    .arrow-btn { width: 34px; height: 34px; border: 1px solid var(--gris-moyen); border-radius: 50%; background: var(--blanc); color: #4A5B4E; cursor: pointer; font-size: 1.1rem; }
...
<body>
  <div class="app-wrapper">
    <aside class="sidebar">
      <div class="logo-area">
        <a class="logo-link" href="VIEW/home.php" aria-label="Kool Healthy">
      ...
      <div class="nav-menu">
        <a class="nav-item" href="VIEW/backoffice.php?tab=dashboard" style="text-decoration:none;color:inherit;"><i class="fas fa-chart-pie"></i><span>Dashboard</span></a>
        <a class="nav-item" href="VIEW/backoffice.php?tab=users" style="text-decoration:none;color:inherit;"><i class="fas fa-users"></i><span>Utilisateurs</span></a>
        <a class="nav-item" href="VIEW/backoffice.php?tab=recipes" style="text-decoration:none;color:inherit;"><i class="fas fa-utensils"></i><span>Recettes</span></a>
        <a class="nav-item" href="VIEW/backoffice.php?tab=ingredients" style="text-decoration:none;color:inherit;"><i class="fas fa-apple-alt"></i><span>Ingrédients</span></a>
      ...
      <div class="sidebar-footer">
        <div class="user-badge">
          ...
          <div class="user-info">
            <p><?php echo htmlspecialchars((string) ($_SESSION['nom'] ?? 'Admin')); ?></p>
    ...
    <main class="main-content">
      ...
      <section id="dashboardContent" class="dashboard-container tab-content">
      ...
      <section id="planContent" class="dashboard-container tab-content">
        <div class="card-panel">
          <div class="panel-header">
            <h3><i class="fas fa-table"></i> Tableau des plans</h3>
            <span class="badge-tech">gestion admin</span>
          </div>
          <p style="color:#5b6f5f; font-size:0.88rem; margin-bottom:14px;">La création et modification des plans se fait depuis le <a href="../plan.php?page=plan-nutritionnel" style="color:#29B6F6;font-weight:600;">module plan</a>.</p>
      ...
      <section id="repasContent" class="dashboard-container tab-content active">
  ...
  <script>
    ...
    document.querySelectorAll('.nav-item[data-tab]').forEach((item) => {
      item.addEventListener('click', () => {
        ...
        if (!tab) return;
        Object.keys(tabs).forEach((key) => { if (tabs[key]) tabs[key].classList.toggle('active', key === tab); });
