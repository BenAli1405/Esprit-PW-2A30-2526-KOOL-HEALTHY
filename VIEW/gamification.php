...
<body>
    <nav class="navbar">
        ...
        <div class="nav-links">
            <a id="navAccueil" style="cursor: pointer;">🏠 Accueil</a>
            <a id="navDefisUnified" style="cursor: pointer;">🏆 Défis & Récompenses</a>
            <div class="notif-wrapper" id="notifWrapper">
                <i class="fas fa-bell" style="font-size: 1.4rem; color: var(--gris-texte);"></i>
            ...
            <button class="btn-outline" id="openSignupBtn">S'inscrire</button>
            <button class="btn-connect" id="openLoginBtn">Se connecter</button>
        </div>
    </nav>
    ...
    <div id="accueilSection">
        <div class="hero">
            <h1>Bienvenue dans votre aventure 🌿<br>Gagnez des points,<br>devenez un héros durable</h1>
            <p>Suivez vos progrès, relevez des défis et inspirez la communauté</p>
        </div>
        <div class="section">
            <h2 class="section-title"><i class="fas fa-chart-line"></i> Votre tableau de bord</h2>
            <div class="stats-user">
                <div class="stat-user-item">
                    <div class="stat-user-value" id="userPoints">0</div>
                    <p>Points totaux</p>
                </div>
                <div class="stat-user-item">
                    <div class="stat-user-value" id="userDefisCompleted">0</div>
                    <p>Défis complétés</p>
                </div>
            </div>
            <div style="margin-top: 1rem;">
                <h3 style="margin-bottom: 1rem; font-weight: 600;"><i class="fas fa-trophy"></i> Vos succès</h3>
                <div class="badge-list" id="userAchievementsList"></div>
            </div>
        </div>
    </div>
